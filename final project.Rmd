...
```{r, warning = FALSE}
#1-50 Ranking
f1 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = `acceptance-rate`)) + geom_point() + xlab("National Ranking") + ylab("Acceptance Rate") + stat_smooth(method = "lm", formula = y ~ x, size = 1)

f2 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = tuition)) + geom_point() + xlab("National Ranking") + ylab("Tuition Fee") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f3 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = `percent-receiving-aid`)) + geom_point() + xlab("National Ranking") + ylab("Percent Receiving Aid") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f4 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = `cost-after-aid`)) + geom_point() + xlab("National Ranking") + ylab("Tution Fee (after receiving aid)") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

#50-100 Ranking
f5 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = `acceptance-rate`)) + geom_point() + xlab("National Ranking") + ylab("Acceptance Rate") + stat_smooth(method = "lm", formula = y ~ x, size = 1)

f6 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = tuition)) + geom_point() + xlab("National Ranking") + ylab("Tuition Fee") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f7 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = `percent-receiving-aid`)) + geom_point() + xlab("National Ranking") + ylab("Percent Receiving Aid") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f8 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = `cost-after-aid`)) + geom_point() + xlab("National Ranking") + ylab("Tution Fee (after receiving aid)") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

grid.arrange(f1, f2, f3, f4, ncol = 2)
grid.arrange(f5, f6, f7, f8, ncol = 2)
```
...
#1-50 Ranking
f9 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = early_career_pay)) + geom_point() + xlab("National Ranking") + ylab("Early Career Pay") + stat_smooth(method = "lm", formula = y ~ x, size = 1)

f10 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = mid_career_pay)) + geom_point() + xlab("National Ranking") + ylab("Mid Career Pay") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f11 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = make_world_better_percent)) + geom_point() + xlab("National Ranking") + ylab("Make World Better Percentage") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f12 <- ggplot(data = rank_diversity_df[1:49, ], aes(x = National.Rank, y = stem_percent)) + geom_point() + xlab("National Ranking") + ylab("STEM Percentage") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

#50-100 Ranking
f13 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = early_career_pay)) + geom_point() + xlab("National Ranking") + ylab("Early Career Pay") + stat_smooth(method = "lm", formula = y ~ x, size = 1)

f14 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = mid_career_pay)) + geom_point() + xlab("National Ranking") + ylab("Mid Career Pay") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f15 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = make_world_better_percent)) + geom_point() + xlab("National Ranking") + ylab("Make World Better Percentage") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

f16 <- ggplot(data = rank_diversity_df[50:96, ], aes(x = National.Rank, y = stem_percent)) + geom_point() + xlab("National Ranking") + ylab("STEM Percentage") + stat_smooth(method = "lm", formula = y ~ x, size = 1)  

grid.arrange(f9, f10, f11, f12, ncol = 2)
